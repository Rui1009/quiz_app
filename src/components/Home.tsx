                    ...
                    <Grid container xs={12}>
                        ...
                        <Grid item xs={6} style={{backgroundColor: "#d9f4fd"}}>
                            <ul>
                                ...
                                <Typography variant={"h5"}>0位</Typography>
                                <hr/>
